...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="row center">
            <h5 class="header col s12 light">Through the firewall   Protect personal privacy</h5>
            {$homeIndexMsg}
        </div>
        {if $user->isLogin}
            <div class="row center">
                <a href="/user" id="download-button" class="btn-large waves-effect waves-light orange">Enter the user center</a>
            </div>
        {else}
        <div class="row center">
            <a href="/auth/register" id="download-button" class="btn-large waves-effect waves-light orange">Register now</a>
        </div>
        {/if}
        <br><br>
    </div>
